...
const description = "These are some stupid emoji for fun rn";
...
const extraMetadata = {
  external_url: "https://StupidEmojis.xyz", // Replace with your website or remove this line if you do not have one.
};
